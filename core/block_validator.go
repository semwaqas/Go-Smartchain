// Copyright 2024 The ZKM EVM Authors
// This file is part of the ZKM EVM library.
//
// The ZKM EVM library is free software: you can redistribute it and/or modify
// it under the terms of the GNU Lesser General Public License as published by
// the Free Software Foundation, either version 3 of the License, or
// (at your option) any later version.
//
// The ZKM EVM library is distributed in the hope that it will be useful,
// but WITHOUT ANY WARRANTY; without even the implied warranty of
// MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the
// GNU Lesser General Public License for more details.
//
// You should have received a copy of the GNU Lesser General Public License
// along with the ZKM EVM library. If not, see <http://www.gnu.org/licenses/>.
package core
import (
	“errors”
	“fmt”
...
func (v *BlockValidator) ValidateWitness(witness *stateless.Witness, receiptRoot common.Hash, stateRoot common.Hash) error {
	...
	// TODO: Self-stateless for now, swap with other clients
